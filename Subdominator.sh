# Subdominator is a bash script which helps to find the subdomains on the basis of ASN number and also from the website cert.sh.
#Written by  Divyanshu Diwakar
#LinkedIn: https://www.linkedin.com/in/divyanshu-diwakar-776ba656/
#Twitter: https://twitter.com/DDiwakr
